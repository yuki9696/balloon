...
class PlaySheetCellRight: UITableViewCell {
    ...
    var animate = false {
        didSet{
            if self.animate == true {
                ...
                //self.bubbleView.backgroundColor = UIColor(red: 0, green: 128.0/255.0, blue: 255.0/255.0, alpha: 1)
...
//        print("Right Cell Title Width: = \(width75)")
